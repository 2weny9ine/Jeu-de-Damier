...
class CanvasDamier(Canvas):
    ...
    def dessiner_pieces(self):
        ...
        for position, piece in self.damier.cases.items():
            ...
            coordonnee_y = (
                position.ligne * self.n_pixels_par_case + self.n_pixels_par_case // 2
            )
            coordonnee_x = (
                position.colonne * self.n_pixels_par_case + self.n_pixels_par_case // 2
            )
